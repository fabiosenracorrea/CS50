## This is the CS50! Week 0

On this directory, the exercises of Week 0 are covered.

### What was week 0 all about?

Week 0 covers some basic understanding on CS behind the scenes, talking a little bit about bits (no pun intended) and algorithm logic.

It also covers MIT's graphical programming language, [Scratch](https://scratch.mit.edu/explore/projects/all).

### What was the exercise here?

Here is the complete description of what should be done:
